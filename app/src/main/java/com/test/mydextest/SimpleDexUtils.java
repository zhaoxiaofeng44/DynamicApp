 ...
 */
  ...
  public class SimpleDexUtils {
    ...
    public static Boolean injectAbove(Context context, String dexPath, String defaultDexOptPath, String nativeLibPath) {
     ...
     * 根据属性名,获取属性
     */
    private static Object getObjectValue(Object obj, String fieldName)
     ...
     * 根据属性名,更改属性
     */
    private static void setObjectValue(Object obj, String fieldName, Object value)
            throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        Field classField = getFieldByClasss(obj,fieldName);
        if(null != classField){
     ...
     */
    private static Field getFieldByClasss(Object object,String fieldName)
